...
|---|---|---:|---:|---:|
| event_study | ✅ PASS | 10 | 0 | 0 |
| dcc_garch | ✅ PASS | 14 | 0 | 0 |
| quantile_reg | ✅ PASS | 9 | 0 | 0 |
...
- ✅ `_verifier/placebo_test.py` — file
- ✅ `_verifier/multiple_testing.py` — file

### 추출된 파라미터
- `est_window`: [('EST_START', '120'), ('EST_START', '120'), ('EST_START', '120')]
- `event_window`: [('EVENT_WINDOW', '17'), ('EVENT_WINDOW', '3'), ('EVENT_WINDOW', '3'), ('EVENT_WINDOW', '17')]
...
- `est_end`: [('EST_END', '26'), ('EST_END', '26'), ('EST_END', '26')]
...
- ✅ **PASS** — Placebo 검증 누락
  - pattern matched: placebo|pseudo[_\s]event
- ✅ **PASS** — 다중비교 보정 누락 (Bonferroni 또는 BH-FDR)
  - pattern matched: bonferroni|benjamini|hochberg|fdr|BH[-_]
- ✅ **PASS** — est_window < 90 거래일
  - 추정창 길이 95일 (≥ 90)
...
### 추출된 파라미터
- `tau`: [('TAUS', '0.01, 0.025, 0.05, 0.10, 0.20, 0.25, 0.50, 0.75, 0.90, 0.95'), ('CORE_TAUS', '0.05, 0.10, 0.50'), ('CORE_TAUS', '0.05, 0.10, 0.50'), ('CORE_TAUS', '0.05, 0.10, 0.50')]
- `n_boot`: None
- `tau_single`: None

### Red Flag 자동 판정
- ✅ **PASS** — τ < 0.01 또는 τ > 0.99 (극단 표본 부족)
  - 모든 τ ∈ [0.01, 0.99]
